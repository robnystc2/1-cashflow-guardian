...
// 1. FAQ: Buscar el array faqItems y reemplazarlo entero, usando una regex más tolerante
...
// Reemplazar TODO el bloque faqItems, incluso si está malformado
code = code.replace(/const faqItems = \[[\s\S]*?\];/, faq8);

// 2. CTA final: corregir "Hablar con el equipo" por "Empezar gratis →"
// Buscamos el texto exacto que aparece en el HTML
code = code.replace(
  /Hablar con el equipo\n\s*Ver comparativa completa de planes →/g,
  'Empezar gratis →\nVer comparativa completa de planes →'
);

fs.writeFileSync('src/app/page.tsx', code);
console.log('✅ FAQ y CTA final corregidos de forma definitiva.');
