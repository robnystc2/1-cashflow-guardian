...
const profesiones = [
  ...
  { role: 'Fotógrafo', icon: 'Camera', pain: 'Las fotos están en su web. El dinero no está en tu cuenta.', count: '18.500€ recuperados', cat: 'Creativo', caseName: 'Diego Martínez', caseDetail: 'Fotógrafo de Buenos Aires. Nunca tuvo un impago gracias al PayScore.' },
  { role: 'Copywriter', icon: 'PenTool', pain: 'Textos publicados. Cobro sin respuesta.', count: '25.400€ recuperados', cat: 'Creativo', caseName: 'Lucía Fernández', caseDetail: 'Copywriter. Sus textos ya estaban indexados.' },
  ...
  { role: 'Asistente Virtual', icon: 'Briefcase', pain: 'Resuelves todo. Honorario en el limbo.', count: '15.300€ recuperados', cat: 'Consultor', caseName: 'Carmen Ruiz', caseDetail: 'Asistente virtual. Organizó sus horas en hitos.' },
  { role: 'Editor de vídeo', icon: 'Film', pain: 'Vídeo en YouTube. Pago retenido.', count: '10.900€ recuperados', cat: 'Creativo', caseName: 'Roberto Vega', caseDetail: 'Editor de vídeo. El 4K se desbloqueaba al pagar.' },
  ...
  { role: 'Productor musical', icon: 'Music', pain: 'Beat en Spotify. Split desaparecido.', count: '3.200€ recuperados', cat: 'Creativo', caseName: 'Andrés Calle', caseDetail: 'Productor musical. Pagos puntuales.' },
