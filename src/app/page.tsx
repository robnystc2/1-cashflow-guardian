...
export default function LandingPage() {
  ...
  const comparisonRows = [
    { feat: 'Protección impago', bonsai: '✗ Ninguna', honeybook: '✗ Ninguna', nosotros: '✓ Garantía Blindaje Total + 3 meses gratis' },
    { feat: 'Bloqueo de entrega', bonsai: '✗ No existe', honeybook: '✗ No existe', nosotros: '✓ Candado físico por hito' },
    { feat: 'Calificación de clientes', bonsai: '✗ No tienen', honeybook: '✗ No tienen', nosotros: '✓ PayScore con historial real' },
    { feat: 'Defensa legal', bonsai: '✗ No ofrecen', honeybook: '✗ No ofrecen', nosotros: '✓ Escudo Legal con jurisdicción local' },
    { feat: 'Precio mensual', bonsai: '17$/mes', honeybook: '19$/mes', nosotros: '29€/mes (con Garantía)' },
    { feat: 'Recordatorios', bonsai: '✗ Manual', honeybook: '✗ Manual', nosotros: '✓ Automático: Amable → Firme → Legal' },
    { feat: 'Velocidad de onboarding', bonsai: '15-20 min', honeybook: '20 min', nosotros: '✓ 3 minutos' },
    { feat: 'Soporte en español', bonsai: '✗ Inglés', honeybook: '✗ Inglés', nosotros: '✓ Español nativo 24/7' },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-emerald-500/30">
      ...
      <LiveStatsBar />
      <div className="bg-zinc-900 text-zinc-400 text-xs text-center py-1">Quedan pocas plazas a 29€/mes. Únete antes de que suba.</div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 max-w-xl mx-auto">
            ...
            <div className="bg-zinc-800 rounded-xl p-6 text-center">
              ...
              <p className="text-xs text-zinc-500 mt-2">También perderás aproximadamente {Math.round(roiPerdida / 30)} horas persiguiendo ese dinero. Con CFG: 0 minutos.</p>
      ...
      <section className="py-12 px-4 bg-zinc-950" id="garantia">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-zinc-400 text-sm mb-8 max-w-2xl mx-auto">Buscamos en Bonsai. No había protección anti-impago. Buscamos en HoneyBook. No existía. Buscamos en Freshbooks. Tampoco. Así que lo construimos nosotros.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <div className="md:col-span-2 bg-zinc-900 border-2 border-emerald-500 rounded-2xl p-8 text-left relative">
              <div className="flex items-center gap-4 mb-4"><div className="w-16 h-16 bg-emerald-500/10 rounded-2xl flex items-center justify-center"><Shield className="w-10 h-10 text-emerald-400" /></div><div>
                <h3 className="text-2xl font-bold">Garantía Blindaje Total <span className="inline-block bg-emerald-500 text-black text-xs font-bold px-3 py-1 rounded-full ml-2">94% NUNCA necesita activarla</span></h3>
              ...
              <div className="text-xs text-zinc-400 mt-3 space-y-2">
                ...
                <p>4. Si en 14 días no has cobrado, te devolvemos 3 meses completos</p>
              </div>
            </div>
          ...
          <div className="bg-amber-900/30 border-2 border-amber-600 rounded-xl p-5 text-center mb-8">
            <p className="text-base text-amber-300 font-semibold">¿Usas Bonsai? Tu herramienta ahora pertenece a Zoom.</p>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-sm">
                {comparisonRows.map((row, i) => (
                  <tr key={i} className="border-b border-zinc-800 hover:bg-white/[0.02]"><td className="py-3 px-4 text-zinc-300">{row.feat}</td><td className="py-3 px-4 text-center text-zinc-400">{row.bonsai}</td><td className="py-3 px-4 text-center text-zinc-400">{row.honeybook}</td><td className="py-3 px-4 text-center bg-emerald-900/20 text-emerald-400 font-bold">{row.nosotros}</td></tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="py-12 px-4 bg-zinc-900/50">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="text-center mt-4"><Link href="/register" className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-black font-semibold px-6 py-3 rounded-full transition-all hover:scale-105 text-sm">Empezar blindaje gratis →</Link></div>
        </div>
      </section>
      ...
      <section id="precios" className="py-12 px-4 bg-zinc-950">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex justify-center mb-4"><span className="bg-amber-500/20 border border-amber-500 text-amber-300 text-xs font-semibold px-3 py-1 rounded-full">🔥 Precio de lanzamiento — 448/500 usuarios</span></div>
          <div className="flex justify-center gap-4 mt-4 text-xs text-zinc-500"><span>🔒 Pago seguro (Stripe)</span><span>🛡️ SSL</span><span>🎉 Lifetime deal disponible</span></div>
          <div className="flex justify-center gap-4 mt-2 text-xs text-zinc-500"><span>🛡️ RGPD Compliant</span><span>🌍 47 países</span></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-zinc-900 border rounded-2xl p-8 flex flex-col transition-all border-zinc-800">
              <h3 className="text-2xl font-bold mb-2">Plan Gratuito</h3><p className="text-xs text-zinc-400 mb-4">Protege hasta 3 facturas al mes.</p>
              ...
              <ul className="text-left text-zinc-300 space-y-3 mb-10 flex-grow text-sm">
                <li className="flex items-start gap-2"><Check className="text-emerald-400 mt-0.5 w-4 h-4" /> 3 facturas/mes</li>
                <li className="flex items-start gap-2"><Check className="text-emerald-400 mt-0.5 w-4 h-4" /> 1 cliente</li>
            ...
            <div className="bg-zinc-900 border-2 rounded-2xl p-8 flex flex-col relative scale-105 border-emerald-500">
              ...
              <p className="text-4xl font-bold text-emerald-400 mb-2">1€ tu primer mes</p>
              <p className="text-3xl font-bold mb-4 text-zinc-300">{prices.pro}€<span className="text-xl text-zinc-400">/{billingCycle === 'annual' ? 'año' : 'mes'}</span>{billingCycle === 'annual' && <span className="text-sm text-emerald-400 block">21€/mes facturado anualmente</span>}</p>
              <ul className="text-left text-zinc-300 space-y-3 mb-10 flex-grow text-sm">
              ...
              <Link href="/register" className="block text-center bg-emerald-500 hover:bg-emerald-400 text-black font-bold py-3.5 px-6 rounded-full transition-all hover:scale-105 shadow-lg shadow-emerald-500/20 cursor-pointer">Probar Pro por 1€ →</Link>
            ...
            <div className="bg-zinc-900 border rounded-2xl p-8 flex flex-col transition-all border-zinc-800">
              ...
              <p className="text-3xl font-bold mb-4 text-zinc-300">{prices.total}€<span className="text-xl text-zinc-400">/{billingCycle === 'annual' ? 'año' : 'mes'}</span>{billingCycle === 'annual' && <span className="text-sm text-emerald-400 block">58€/mes facturado anualmente</span>}</p>
              <ul className="text-left text-zinc-300 space-y-3 mb-10 flex-grow text-sm">
                ...
                <li className="flex items-start gap-2"><Check className="text-emerald-400 mt-0.5 w-4 h-4" /> Soporte prioritario 1h · Garantía de por vida</li>
              </ul>
            ...
            <div className="bg-zinc-900 border rounded-2xl p-8 flex flex-col transition-all border-zinc-800">
              <h3 className="text-2xl font-bold mb-2">CFG Agencia</h3><p className="text-xs text-zinc-400 mb-4">Para cuando tu freelance se convierta en agencia.</p>
              <p className="text-3xl font-bold mb-4 text-zinc-300">149€<span className="text-xl text-zinc-400">/mes</span></p>
              <ul className="text-left text-zinc-300 space-y-3 mb-10 flex-grow text-sm">
                <li className="flex items-start gap-2"><Check className="text-emerald-400 mt-0.5 w-4 h-4" /> Todo lo de Élite</li>
                <li className="flex items-start gap-2"><Check className="text-emerald-400 mt-0.5 w-4 h-4" /> Hasta 10 colaboradores</li>
                <li className="flex items-start gap-2"><Check className="text-emerald-400 mt-0.5 w-4 h-4" /> Dashboard de equipo</li>
                <li className="flex items-start gap-2"><Check className="text-emerald-400 mt-0.5 w-4 h-4" /> API access</li>
              </ul>
              <Link href="/register" className="block text-center bg-emerald-500 hover:bg-emerald-400 text-black font-semibold py-3 px-6 rounded-full transition-all hover:scale-105 shadow-lg shadow-emerald-500/20 cursor-pointer">Empezar con Agencia</Link>
              <p className="text-xs text-zinc-400 mt-3 text-center">🛡️ Garantía devolución 30 días · Sin preguntas</p>
            </div>
          </div>
          <p className="text-xs text-zinc-500 mt-6 text-center">Todos los precios en euros (€). Sin costes ocultos. Sin permanencia. ¿Eres estudiante? <a href="mailto:hola@cashflowguardian.com" className="text-emerald-400 underline">Pide tu descuento →</a></p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-emerald-950/20 border-y border-emerald-900/20">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-xs text-zinc-400">Sin tarjeta · 14 días gratis · Garantía Blindaje Total incluida</p>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
            <div>
              ...
              <p className="text-zinc-600 text-[10px] mt-2">🔒 SSL Seguro · RGPD Compliant · Stripe Verified Partner · Empresa verificada</p>
            </div>
