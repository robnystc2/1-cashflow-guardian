      ...
      <section className="py-16 px-4 max-w-4xl mx-auto text-center">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 mb-8">
          ...
          <div className="flex gap-2 max-w-sm mx-auto">
            ...
            <button className="bg-emerald-500 hover:bg-emerald-400 text-black font-semibold text-sm px-4 py-2 rounded-full transition-all whitespace-nowrap">Avísame cuando abra</button>
          </div>
          <p className="text-xs text-zinc-500 mt-3">Sé el primero en entrar cuando lancemos la comunidad.</p>
        </div>
      </section>
    </div>
  )
