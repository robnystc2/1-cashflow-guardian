...
export default function LandingFotografos() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-4xl mx-auto pt-24 pb-16 px-4 text-center">
        <p className="text-sm text-red-400/80 font-medium mb-2">18.500€ recuperados para Fotógrafos</p>
        <h1 className="text-4xl md:text-6xl font-extrabold mb-4">Protege tus proyectos de Fotógrafos con CFG</h1>
        <p className="text-lg text-zinc-300 mb-4 italic">"Las fotos están en su web. Tu factura sigue en el limbo."</p>
        <p className="text-lg text-zinc-300 mb-8 max-w-2xl mx-auto">El 94% de nuestros usuarios Fotógrafos cobran en menos de 14 días. Si no, te devolvemos 3 meses.</p>
