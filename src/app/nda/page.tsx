  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="py-16 px-4 max-w-3xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Plantilla de <span className="text-emerald-400">NDA</span> gratuita</h1>
        <p className="text-xl text-zinc-300 mb-8">Acuerdo de Confidencialidad listo para usar con tus clientes. Protege tus ideas antes de compartirlas.</p>
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 mb-8">
          <p className="text-sm text-zinc-400 mb-4">Descarga la plantilla en PDF y adáptala a tu proyecto.</p>
          <button className="bg-emerald-500 hover:bg-emerald-400 text-black font-semibold text-sm px-6 py-3 rounded-full transition-all">Descargar NDA (gratis)</button>
        </div>
