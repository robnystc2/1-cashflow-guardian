...
export default function LandingEditoresvideo() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-4xl mx-auto pt-24 pb-16 px-4 text-center">
        <p className="text-sm text-red-400/80 font-medium mb-2">10.900€ recuperados para Editores de Vídeo</p>
        <h1 className="text-4xl md:text-6xl font-extrabold mb-4">Protege tus proyectos de Editores de Vídeo con CFG</h1>
        <p className="text-lg text-zinc-300 mb-4 italic">"30 horas de edición. El canal tiene 50.000 reproducciones. Tu factura lleva 45 días esperando."</p>
        <p className="text-lg text-zinc-300 mb-8 max-w-2xl mx-auto">El 94% de nuestros usuarios Editores de Vídeo cobran en menos de 14 días. Si no, te devolvemos 3 meses.</p>
