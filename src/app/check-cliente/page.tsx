    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-24 pb-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="max-w-md mx-auto">
          <input type="text" placeholder="Email, LinkedIn o nombre de empresa" value={email} onChange={e => setEmail(e.target.value)} className="w-full bg-zinc-800 border border-zinc-700 rounded-full px-4 py-2 text-sm text-white mb-4" />
