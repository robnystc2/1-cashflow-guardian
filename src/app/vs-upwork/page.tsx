...
export default function ComparativaUpwork() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-4xl mx-auto pt-24 pb-16 px-4">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-4 text-center">CFG vs Upwork</h1>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-zinc-700 text-zinc-300 text-sm">
                ...
                <th className="py-3 px-4 text-center">Upwork</th>
            ...
            <tbody className="text-sm">
              ...
              <tr className="border-b border-zinc-700/50"><td className="py-3 px-4 text-zinc-300">Precio</td><td className="py-3 px-4 text-center text-zinc-400">10% comisión</td><td className="py-3 px-4 text-center bg-emerald-900/20 text-emerald-400 font-bold">29€/mes</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-6">
            <h3 className="text-amber-400 font-bold mb-4">✅ Ventajas de Upwork</h3>
            <ul className="space-y-2">
              <li className="flex items-start gap-2"><span className="text-amber-400">•</span><span className="text-sm text-zinc-300">Plataforma freelance</span></li>
<li className="flex items-start gap-2"><span className="text-amber-400">•</span><span className="text-sm text-zinc-300">Protección de pago</span></li>
            </ul>
          </div>
          <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-6">
            <h3 className="text-red-400 font-bold mb-4">❌ Limitaciones frente a CFG</h3>
            <ul className="space-y-2">
              <li className="flex items-start gap-2"><span className="text-red-400">•</span><span className="text-sm text-zinc-300">Comisión altísima</span></li>
<li className="flex items-start gap-2"><span className="text-red-400">•</span><span className="text-sm text-zinc-300">No puedes tener relación directa</span></li>
<li className="flex items-start gap-2"><span className="text-red-400">•</span><span className="text-sm text-zinc-300">Sin herramientas legales</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-amber-900/30 border border-amber-700 rounded-xl p-6 mb-8">
          <h3 className="text-amber-300 font-bold mb-2">📋 Guía de migración de Upwork a CFG</h3>
          ...
          <ol className="text-sm text-zinc-300 space-y-1 list-decimal list-inside">
            <li>Exporta tus clientes y proyectos activos de Upwork.</li>
