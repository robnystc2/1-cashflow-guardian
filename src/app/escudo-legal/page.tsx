    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto text-center">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 mb-8 text-left">
          <h3 className="font-bold mb-4">¿Qué es?</h3>
          <p className="text-sm text-zinc-300">Una carta de reclamación extrajudicial generada automáticamente, adaptada a la legislación de tu país (España, México, Argentina, Colombia, Chile y 20+ países más).</p>
        </div>
