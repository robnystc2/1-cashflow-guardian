...
export default function InformeImpago() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="py-16 px-4 max-w-3xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Informe anual del <span className="text-emerald-400">impago freelance</span></h1>
        <p className="text-xl text-zinc-300 mb-8">Datos reales sobre tasas de impago por sector, país y tipo de proyecto. Basado en nuestra red de freelancers.</p>
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 mb-8">
          <p className="text-sm text-zinc-400 mb-4">📊 Primer informe disponible próximamente. Déjanos tu email para recibirlo.</p>
