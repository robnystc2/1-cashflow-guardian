  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-4xl mx-auto pt-24 pb-16 px-4 text-center">
        <p className="text-sm text-red-400/80 font-medium mb-2">5.600€ recuperados para Coaches y Terapeutas</p>
        <h1 className="text-4xl md:text-6xl font-extrabold mb-4">Protege tus proyectos de Coaches y Terapeutas con CFG</h1>
        <p className="text-lg text-zinc-300 mb-4 italic">"Sesiones dadas. Factura olvidada."</p>
        <p className="text-lg text-zinc-300 mb-8 max-w-2xl mx-auto">El 94% de nuestros usuarios Coaches y Terapeutas cobran en menos de 14 días. Si no, te devolvemos 3 meses.</p>
