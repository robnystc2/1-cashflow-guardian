...
export default function ContratoCoach() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-24 pb-16 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-4">Contrato freelance para coach</h1>
        <p className="text-zinc-300 mb-6">Descarga nuestra plantilla gratuita de contrato para coach y protégete legalmente.</p>
