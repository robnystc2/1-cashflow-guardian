      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="max-w-md w-full">
          <div className="mb-8">
            ...
            <p className="text-zinc-400 mt-2">3 pasos · 3 minutos</p>
          ...
          <form className="space-y-4">
            ...
            <div><label className="text-sm text-zinc-400">¿Cuál es tu profesión?</label><select className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white outline-none focus:border-emerald-500"><option>Diseñador</option><option>Desarrollador</option><option>Consultor</option><option>Fotógrafo</option><option>Otro</option></select></div>
