  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="py-16 px-4 max-w-3xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Generador de <span className="text-emerald-400">contratos</span></h1>
        <p className="text-xl text-zinc-300 mb-8">Crea un contrato con hitos en 3 minutos. Adaptado a tu país y tipo de proyecto.</p>
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 mb-8">
          <p className="text-zinc-400">Disponible próximamente en el dashboard de CFG.</p>
        </div>
        <Link href="/register" className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-black font-bold text-lg px-10 py-4 rounded-full transition-all hover:scale-105 shadow-lg shadow-emerald-500/20">Probar CFG gratis <ArrowRight className="w-5 h-5" /></Link>
      </section>
    </div>
  )
}
