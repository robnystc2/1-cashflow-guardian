...
export default function Articulocalculartarifahorafreelanceespana() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-24 pb-16 px-4">
      <article className="max-w-4xl mx-auto">
        <p className="text-xs text-zinc-500 mb-2">Blog · Negocio</p>
        <h1 className="text-4xl font-bold mb-4">Cómo calcular tu tarifa por hora como freelancer en España</h1>
