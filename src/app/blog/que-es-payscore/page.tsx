...
export const metadata: Metadata = {
  title: 'Qué es el PayScore y cómo te ayuda a evitar clientes morosos | Blog CFG',
  description: 'Descubre cómo funciona el sistema de calificación de clientes de CFG y cómo puede ahorrarte miles de euros en impagos.',
}
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white py-16 px-4">
      <article className="max-w-3xl mx-auto prose prose-invert">
        <h1>Qué es el PayScore</h1>
        <p className="lead text-lg text-zinc-300">El PayScore es el historial de pagos de un cliente dentro de la red de freelancers de CFG. Antes de aceptar un proyecto, puedes consultar si ese cliente paga puntualmente o tiene historial de impago.</p>
