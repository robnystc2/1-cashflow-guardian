    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <article className="max-w-4xl mx-auto pt-24 pb-16 px-4">
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4">Qué hacer si un cliente dice que no tiene dinero para pagarte</h1>
          <p className="text-lg text-zinc-400 leading-relaxed">Estrategias legales y negociación para cobrar cuando el cliente alega falta de fondos.</p>
        </div>
