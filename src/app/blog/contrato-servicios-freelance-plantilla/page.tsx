    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <article className="max-w-4xl mx-auto pt-24 pb-16 px-4">
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4">Contrato de servicios freelance: plantilla Word descargable</h1>
          <p className="text-lg text-zinc-400 leading-relaxed">Descarga nuestra plantilla gratuita de contrato de servicios freelance.</p>
        </div>
