    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <article className="max-w-4xl mx-auto pt-24 pb-16 px-4">
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4">Cómo calcular tu tarifa por hora como freelancer en España</h1>
          <p className="text-lg text-zinc-400 leading-relaxed">Fórmula para calcular tu precio por hora considerando gastos, impuestos y margen.</p>
        </div>
