...
export default function Articuloclientedicenotienedineropagar() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-24 pb-16 px-4">
      <article className="max-w-4xl mx-auto">
        <p className="text-xs text-zinc-500 mb-2">Blog · Cobros</p>
        <h1 className="text-4xl font-bold mb-4">Qué hacer si un cliente dice que no tiene dinero para pagarte</h1>
