...
export default function ComparativaMoxie() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-4xl mx-auto pt-24 pb-16 px-4">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-4 text-center">CFG vs Moxie</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-6">
            <h3 className="text-amber-400 font-bold mb-4">✅ Ventajas de Moxie</h3>
            <ul className="space-y-2">
              <li className="flex items-start gap-2"><span className="text-amber-400">•</span><span className="text-sm text-zinc-300">CRM freelance</span></li>
<li className="flex items-start gap-2"><span className="text-amber-400">•</span><span className="text-sm text-zinc-300">Facturación</span></li>
            </ul>
          </div>
          <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-6">
            <h3 className="text-red-400 font-bold mb-4">❌ Limitaciones frente a CFG</h3>
            <ul className="space-y-2">
              <li className="flex items-start gap-2"><span className="text-red-400">•</span><span className="text-sm text-zinc-300">Sin bloqueo de entregas</span></li>
<li className="flex items-start gap-2"><span className="text-red-400">•</span><span className="text-sm text-zinc-300">Sin Escudo Legal</span></li>
<li className="flex items-start gap-2"><span className="text-red-400">•</span><span className="text-sm text-zinc-300">Sin soporte español</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-amber-900/30 border border-amber-700 rounded-xl p-6 mb-8">
          <h3 className="text-amber-300 font-bold mb-2">📋 Guía de migración de Moxie a CFG</h3>
          ...
          <ol className="text-sm text-zinc-300 space-y-1 list-decimal list-inside">
            <li>Exporta tus clientes y proyectos activos de Moxie.</li>
