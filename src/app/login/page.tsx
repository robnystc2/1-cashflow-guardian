    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center p-8">
      <div className="max-w-md w-full">
        <div className="mb-8">
          ...
          <p className="text-zinc-400 text-sm mt-2">Bienvenido de vuelta. Tus proyectos blindados te esperan. "Activé el Escudo Legal y en 48 horas el cliente pagó." — Javier Herrera</p>
        </div>
        <form className="space-y-4">
          ...
          <Link href="/forgot-password" className="text-xs text-emerald-400 hover:text-emerald-300 block text-right">¿Problemas para entrar?</Link>
