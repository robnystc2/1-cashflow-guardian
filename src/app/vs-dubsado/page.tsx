  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto text-center">
        <h1 className="text-4xl font-bold mb-4">CFG vs <span className="text-zinc-400">Dubsado</span></h1>
        <p className="text-xl text-zinc-300 mb-8">Descubre por qué CFG es la mejor alternativa a Dubsado para freelancers.</p>
