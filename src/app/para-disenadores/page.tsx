...
export default function ParaDisenadores() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto text-center">
        <h1 className="text-4xl font-bold mb-4">Protege tus proyectos como <span className="text-emerald-400">Disenadores</span></h1>
        <p className="text-xl text-zinc-300 mb-8">La protección anti-impago específica para tu profesión. Con casos reales de Disenadores que ya cobran siempre.</p>
