  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto">
        ...
        <p className="text-zinc-300 text-center mb-12">Freelancers reales que recuperaron su dinero con CFG. Historias verificables con datos reales. Historias verificables con datos reales.</p>
