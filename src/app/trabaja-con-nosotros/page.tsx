  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="py-16 px-4 max-w-2xl mx-auto text-center">
        <h1 className="text-4xl font-bold mb-4">Trabaja con <span className="text-emerald-400">nosotros</span></h1>
        <p className="text-zinc-300 mb-8">Estamos construyendo el futuro de la protección freelance. ¿Quieres formar parte?</p>
        <p className="text-zinc-400">Escríbenos a <a href="mailto:hola@cashflowguardian.com" className="text-emerald-400 underline">hola@cashflowguardian.com</a></p>
      </section>
    </div>
  )
}
