...
export default function VsPage() {
  const rows = [
    ...
    { feat: 'Escudo Legal', comp: '✗', cfg: '✓ Automático' },
    { feat: 'Precio', comp: 'Variable', cfg: '29€/mes' },
  ]
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-zinc-300 mb-10">Comparativa detallada.</p>
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead><tr className="border-b border-zinc-800 text-sm"><th className="py-3 px-4">Funcionalidad</th><th className="py-3 px-4 text-center">Competencia</th><th className="py-3 px-4 text-center bg-emerald-900/20 text-emerald-400 font-semibold">CFG</th></tr></thead>
